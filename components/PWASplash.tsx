...
export default function PWASplash() {
  ...
  return (
    <div className="pwa-splash" aria-hidden="true">
      ...
      <h1 className="text-white text-xl font-bold mb-2">{DEFAULT_SITE_NAME}</h1>
      <p className="text-[#BE185D] text-sm font-medium mb-8">Smart Sourcing, Seamless Shopping</p>
