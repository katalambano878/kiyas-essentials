  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-br from-[#BE185D] to-[#9D174D] text-white rounded-full shadow-2xl hover:scale-110 transition-transform z-50 flex items-center justify-center"
      >
        {isOpen ? (
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-96 h-[600px] bg-white rounded-2xl shadow-2xl z-50 flex flex-col overflow-hidden border border-gray-200">
          <div className="bg-gradient-to-r from-[#BE185D] to-[#9D174D] text-white p-4">
            <div className="flex items-center gap-3">
              <div className="relative">
                <div className="w-12 h-12 flex items-center justify-center bg-white text-[#BE185D] rounded-full font-bold text-xl">
              ...
              >
                <div className={`max-w-[75%] ${msg.sender === 'user' ? 'order-2' : 'order-1'}`}>
                  <div className={`px-4 py-2 rounded-2xl ${
                    msg.sender === 'user'
                      ? 'bg-[#BE185D] text-white rounded-br-sm'
          ...
          <div className="border-t border-gray-200 p-3 bg-white">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 px-4 py-2 bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-[#BE185D]"
              />
              <button
                onClick={handleSendMessage}
                className="w-9 h-9 flex items-center justify-center bg-[#BE185D] hover:bg-[#9D174D] text-white rounded-full transition-colors"
              >
