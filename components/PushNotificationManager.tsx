  ...
  return (
    <div className="fixed bottom-4 right-4 w-96 bg-white rounded-xl shadow-2xl p-6 z-50 border border-gray-200 animate-slide-up">
      <div className="flex items-start gap-4">
        <div className="w-12 h-12 bg-[#BE185D]/10 rounded-xl flex items-center justify-center flex-shrink-0">
          <i className="ri-notification-line text-2xl text-[#BE185D]"></i>
        </div>
        <div className="flex-1">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 bg-[#BE185D] hover:bg-[#9D174D] text-white py-2 px-4 rounded-lg font-medium transition-colors whitespace-nowrap"
            >
