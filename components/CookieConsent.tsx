...
export default function CookieConsent() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t-4 border-[#BE185D] shadow-2xl z-[9999] animate-slide-up">
              ...
              <div className="flex items-start space-x-4 flex-1">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed mb-3">
                    ...
                    <Link href="/privacy" className="text-[#BE185D] hover:text-[#9D174D] font-medium ml-1 whitespace-nowrap">
                  ...
                  <label className="flex items-start space-x-2 cursor-pointer group">
                    <input
                      ...
                      className="w-4 h-4 mt-0.5 text-[#BE185D] border-gray-300 rounded focus:ring-[#BE185D] cursor-pointer"
                    />
                    <span className="text-xs text-gray-600 group-hover:text-gray-900">
                      I agree to the{' '}
                      <Link href="/terms" className="text-[#BE185D] hover:text-[#9D174D] font-medium">
                        Terms & Conditions
                      </Link>
                      {' '}and{' '}
                      <Link href="/privacy" className="text-[#BE185D] hover:text-[#9D174D] font-medium">
                        Privacy Policy
                      </Link>
                    </span>
                  </label>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors cursor-pointer ${
                      preferences.analytics ? 'bg-[#BE185D]' : 'bg-gray-300'
                    }`}
                  >
                ...
                <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors cursor-pointer ${
                      preferences.marketing ? 'bg-[#BE185D]' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
                ...
                <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors cursor-pointer ${
                      preferences.functional ? 'bg-[#BE185D]' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
