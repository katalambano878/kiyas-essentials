...
const STORAGE_KEY = 'store-chat-messages';
const SESSION_KEY = 'store-chat-session';

const WIDGET_TITLE = DEFAULT_SITE_NAME;
...
const STATUS_COLORS: Record<string, string> = {
  pending: 'bg-[#FFFFCC] text-[#BE185D]',
  processing: 'bg-[#BE185D]/10 text-[#BE185D]',
  shipped: 'bg-[#BE185D]/10 text-[#BE185D]',
  dispatched_to_rider: 'bg-[#BE185D]/10 text-[#BE185D]',
  delivered: 'bg-gray-100 text-gray-900',
  cancelled: 'bg-[#FFCCCC] text-[#9A1900]',
  open: 'bg-[#BE185D]/10 text-[#BE185D]',
  in_progress: 'bg-[#FFFFCC] text-[#BE185D]',
...
function TicketCard({ ticket }: { ticket: ChatTicket }) {
  return (
    <div className="bg-white rounded-xl border border-[#BE185D]/20 shadow-sm overflow-hidden">
      <div className="px-4 py-3 bg-[#BE185D]/5">
        <div className="flex items-center gap-2 mb-1">
          <i className="ri-customer-service-2-line text-[#BE185D]" />
          <span className="text-xs font-bold text-[#BE185D]">Support Ticket Created</span>
        </div>
        <div className="flex items-center justify-between">
          <p className="text-sm font-medium text-gray-900">{ticket.subject}</p>
          <span className="text-xs font-mono text-[#BE185D]">#{ticket.ticket_number}</span>
        </div>
  ...
  return (
    <div className="bg-white rounded-xl border border-[#FFCC00]/30 shadow-sm overflow-hidden">
      <div className="px-4 py-3 bg-[#FFFFCC]/50">
        <div className="flex items-center gap-2 mb-1">
          <i className="ri-arrow-go-back-line text-[#BE185D]" />
          <span className="text-xs font-bold text-[#BE185D]">Return Request Submitted</span>
        </div>
