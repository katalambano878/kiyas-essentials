// Kiyas Essentials - network-first pages; no HTML shell cache (playbook section 16)
const CACHE_VERSION = 'sw-v2.5-kiyas';
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    body: data.body || 'New update from Kiyas Essentials',
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || 'Kiyas Essentials', options)
  );
});
