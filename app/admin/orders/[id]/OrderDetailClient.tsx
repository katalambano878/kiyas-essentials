...
import { DEFAULT_CONTACT_EMAIL, DEFAULT_SITE_NAME } from '@/lib/site-defaults';
      ...
      <div className="print-section hidden print:block bg-white p-8">
        <div className="border-2 border-gray-800 p-6">
          ...
          <div className="flex justify-between items-start border-b-2 border-gray-800 pb-4 mb-4">
            <div>
              <h1 className="text-2xl font-bold">{DEFAULT_SITE_NAME}</h1>
...
<p>Thank you for shopping with {DEFAULT_SITE_NAME}!</p>
              <p>Questions? Contact us at {DEFAULT_CONTACT_EMAIL}</p>
          </div>
        </div>
      </div>
