      ...
      <main className="min-h-screen bg-gray-50 flex items-center justify-center py-12">
        <div className="max-w-2xl mx-auto px-4">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <div className="mb-8 p-6 bg-[#BE185D]/5 border border-[#BE185D]/20 rounded-xl text-left">
              <h2 className="font-bold text-gray-900 mb-4 flex items-center">
                <i className="ri-mail-line text-2xl text-[#BE185D] mr-2"></i>
                Check Your Email
              </h2>
          ...
          <div className="mt-8 bg-[#FFFFCC] border border-[#BE185D]/30 rounded-xl p-6">
            <div className="flex items-start space-x-3">
              <i className="ri-alert-line text-2xl text-[#BE185D] mt-0.5"></i>
              <div>
                <p className="font-semibold text-[#BE185D] mb-2">Important Reminders</p>
