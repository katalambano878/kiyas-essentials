...
export default function ShippingPage() {
  ...
  const zones = [
    {
      zone: 'Zone 1 - Greater Accra Metro',
      areas: 'Accra Central, Airport Residential, East Legon, Labone, Cantonments, Osu, Adabraka',
      standard: '1-2 days',
      express: 'Next day'
    },
    {
      zone: 'Zone 2 - Greater Accra Suburbs',
      areas: 'Tema, Madina, Adenta, Ashiaman, Teshie, Nungua, Spintex, Sakumono',
      standard: '2-3 days',
      express: 'Next day'
    },
    {
      zone: 'Zone 3 - Major Cities',
      areas: 'Kumasi, Takoradi, Tamale, Cape Coast, Sunyani, Koforidua, Ho, Wa',
      standard: '3-4 days',
      express: '1-2 days'
    },
    {
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-12 h-12 bg-[#BE185D]/10 rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-checkbox-circle-line text-2xl text-[#BE185D]"></i>
              </div>
              <p className="font-medium text-gray-900">Order Confirmed</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[#FFFFCC] rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-package-line text-2xl text-[#BE185D]"></i>
              </div>
              <p className="font-medium text-gray-900">Processing</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[#BE185D]/10 rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-truck-line text-2xl text-[#BE185D]"></i>
              </div>
