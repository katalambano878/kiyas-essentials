      ...
      {showConfetti && (
        <div className="fixed inset-0 pointer-events-none z-50 overflow-hidden">
          {[...Array(50)].map((_, i) => (
            ...
            >
              <i className={`ri-${['heart', 'star', 'gift'][Math.floor(Math.random() * 3)]}-fill ${['text-gray-500', 'text-[#FFCC00]', 'text-[#BE185D]'][Math.floor(Math.random() * 3)]} text-xl opacity-70`}></i>
            </div>
          ))}
        </div>
      )}
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center mb-8">
            ...
            <div className="bg-gradient-to-r from-[#FFFFCC]/50 to-[#F3F3F3] rounded-xl p-6 border-2 border-[#FFCC00]/30">
              <div className="flex items-center justify-between">
                ...
                <Link
                  href="/register"
                  className="bg-[#FFCC00] hover:bg-[#9D174D] text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
                >
                  Join Now
                </Link>
              </div>
                  ...
                  <div key={item.id} className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      {item.metadata?.preorder_shipping && (
                        <p className="text-xs text-[#BE185D] bg-[#FFFFCC]/50 inline-flex items-center gap-1 px-2 py-0.5 rounded mt-1 border border-[#FFCC00]/30">
