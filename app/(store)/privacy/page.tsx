        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              To exercise any of these rights, please contact us at <a href={`mailto:${DEFAULT_CONTACT_EMAIL}`} className="text-gray-900 font-medium hover:underline">{DEFAULT_CONTACT_EMAIL}</a> or through your account settings. We will respond within 30 days.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              This store does not knowingly collect personal information from individuals under the age of 18. All purchases and account registrations must be completed by an adult. If you believe data from a minor was submitted in error, contact us and we will remove it promptly.
            </p>
          </section>
