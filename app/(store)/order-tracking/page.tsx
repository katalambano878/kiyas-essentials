...
function OrderTrackingContent() {
  ...
  const getStatusBadge = () => {
    ...
    const statusMap: Record<string, { label: string; color: string }> = {
      'pending': { label: 'Pending', color: 'bg-[#FFFFCC] text-[#BE185D]' },
      'processing': { label: 'Processing', color: 'bg-[#BE185D]/10 text-[#BE185D]' },
      'shipped': { label: 'Packaged', color: 'bg-[#BE185D]/10 text-[#BE185D]' },
      'dispatched_to_rider': { label: 'Dispatched To Rider', color: 'bg-[#BE185D]/10 text-[#BE185D]' },
      ...
      <main className="min-h-screen bg-gray-50 py-12 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-sm p-8">
            <form onSubmit={handleTrack} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. ORD-1770328211911-915 or TRK-ABC123"
                />
              </div>
            ...
            <div className="mt-8 p-4 bg-[#BE185D]/5 border border-[#BE185D]/20 rounded-lg">
              <div className="flex items-start space-x-3">
                <i className="ri-information-line text-xl text-[#BE185D] mt-0.5"></i>
                <div>
                  <p className="text-sm font-semibold text-[#BE185D]">Need Help?</p>
                  <p className="text-sm text-[#BE185D] mt-1">
