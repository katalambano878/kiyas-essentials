  ...
  return (
    <main className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            ...
            {wishlistItems.length > 0 && (
              <button
                ...
                className="bg-[#BE185D] hover:bg-[#9D174D] text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
              >
                Add All to Cart
              </button>
            )}
      ...
      {wishlistItems.length === 0 ? (
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
            ...
            <Link href="/shop" className="inline-block bg-[#BE185D] hover:bg-[#9D174D] text-white px-8 py-4 rounded-lg font-semibold transition-colors whitespace-nowrap">
              Explore Products
            </Link>
          </div>
        </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="bg-gradient-to-r from-[#BE185D] to-[#9D174D] rounded-2xl p-12 text-center text-white shadow-[0_16px_45px_rgba(190,24,93,0.3)]">
            <h2 className="text-3xl font-bold mb-4">Share Your Wishlist</h2>
            <p className="text-white/85 mb-8 text-lg">Let friends and family know what you love</p>
