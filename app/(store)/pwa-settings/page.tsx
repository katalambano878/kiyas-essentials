        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
              <div className="w-10 h-10 bg-[#BE185D]/10 rounded-full flex items-center justify-center">
                <i className="ri-smartphone-line text-[#BE185D]"></i>
              </div>
              Installation Status
            </h2>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
              <div className="w-10 h-10 bg-[#BE185D]/10 rounded-full flex items-center justify-center">
                <i className="ri-notification-line text-[#BE185D]"></i>
              </div>
              Notifications
            </h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                ...
                {notificationPermission === 'default' && (
                  <button
                    ...
                    className="px-4 py-2 bg-[#BE185D] text-white rounded-lg hover:bg-[#9D174D] transition-colors whitespace-nowrap"
                  >
                    Enable
                  </button>
                )}
              ...
              {notificationPermission === 'granted' && (
                <div className="bg-[#BE185D]/10 border border-[#BE185D]/20 rounded-xl p-4">
                  <p className="text-sm text-[#BE185D] font-medium mb-2">You will receive notifications for:</p>
                  <ul className="space-y-1 text-sm text-[#BE185D]/80">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
              <div className="w-10 h-10 bg-[#FFFFCC] rounded-full flex items-center justify-center">
                <i className="ri-database-line text-[#BE185D]"></i>
              </div>
              Storage & Cache
            </h2>
            <div className="space-y-4">
              <div className="p-4 bg-gray-50 rounded-xl">
                ...
                <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                  <div
                    className="bg-[#BE185D] h-full rounded-full transition-all"
              ...
              <div className="bg-[#FFFFCC] border border-[#FFCC00]/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  <i className="ri-information-line text-[#BE185D] text-xl"></i>
                  <div className="text-sm text-[#BE185D]">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-[#BE185D]/10 rounded-xl">
                <div className="flex items-center gap-3 mb-2">
                  <i className="ri-rocket-line text-[#BE185D] text-xl"></i>
                  <span className="font-semibold text-[#BE185D]">Fast Loading</span>
                </div>
                <p className="text-sm text-[#BE185D]/80">Instant page loads with smart caching</p>
              </div>
              <div className="p-4 bg-[#BE185D]/10 rounded-xl">
                <div className="flex items-center gap-3 mb-2">
                  <i className="ri-home-line text-[#BE185D] text-xl"></i>
                  <span className="font-semibold text-[#BE185D]">Home Screen</span>
                </div>
                <p className="text-sm text-[#BE185D]/80">Add to home screen like a native app</p>
              </div>
              <div className="p-4 bg-[#FFFFCC]/50 rounded-xl">
                <div className="flex items-center gap-3 mb-2">
                  <i className="ri-refresh-line text-[#BE185D] text-xl"></i>
                  <span className="font-semibold text-[#BE185D]">Auto Updates</span>
                </div>
                <p className="text-sm text-[#BE185D]/80">Automatic updates in the background</p>
              </div>
            </div>
          </div>
        </div>
