    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  <label className={`flex-1 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                    formData.priority === 'normal' ? 'border-[#BE185D] bg-[#BE185D]/5' : 'border-gray-300'
                  }`}>
                    <input
                      type="radio"
                      value="normal"
          ...
          <div className="mt-8 bg-[#BE185D]/5 border border-[#BE185D]/20 rounded-xl p-6">
            <div className="flex items-start space-x-3">
              <i className="ri-information-line text-2xl text-[#BE185D] mt-0.5"></i>
              <div>
                <p className="font-semibold text-[#BE185D] mb-2">Before submitting a ticket</p>
                <ul className="text-sm text-[#BE185D] space-y-1">
                  <li>• Check our <Link href="/help" className="underline hover:text-[#9D174D]">Help Center</Link> for quick answers</li>
