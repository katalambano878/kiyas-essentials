...
export default function MyTicketsPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'open': return 'bg-[#BE185D]/10 text-[#BE185D]';
      case 'in_progress': return 'bg-[#FFFFCC] text-[#BE185D]';
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      ...
      case 'normal': return 'text-[#BE185D]';
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="w-12 h-12 flex items-center justify-center bg-[#BE185D]/10 rounded-lg mb-4">
                <i className="ri-time-line text-2xl text-[#BE185D]"></i>
              </div>
              <h3 className="font-bold text-gray-900 mb-2">Response Time</h3>
              <p className="text-2xl font-bold text-[#BE185D] mb-1">24 hours</p>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="w-12 h-12 flex items-center justify-center bg-[#BE185D]/10 rounded-lg mb-4">
                <i className="ri-customer-service-line text-2xl text-[#BE185D]"></i>
              </div>
              <h3 className="font-bold text-gray-900 mb-2">Support Hours</h3>
              <p className="text-2xl font-bold text-[#BE185D] mb-1">24/7</p>
