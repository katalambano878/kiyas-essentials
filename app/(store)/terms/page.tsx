      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              All prices are listed in Ghana Cedis (GHS) unless otherwise stated. Taxes or duties may apply as shown at checkout. We reserve the right to:
            </p>
            <ul className="space-y-2 text-gray-600 mb-6">
              <li className="flex items-start gap-2">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              All content on this website, including text, graphics, logos, images, videos, and software, is the property of the store operator or its content suppliers and is protected by copyright, trademark, and other intellectual property laws.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              To the fullest extent permitted by law, the store operator shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from:
            </p>
            <ul className="space-y-2 text-gray-600 mb-6">
              <li className="flex items-start gap-2">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              You agree to indemnify and hold harmless the store operator, its affiliates, officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from your use of the website, violation of these terms, or infringement of any third-party rights.
            </p>
          </section>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${DEFAULT_CONTACT_EMAIL}`} className="text-gray-900 hover:underline">{DEFAULT_CONTACT_EMAIL}</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={`tel:${DEFAULT_CONTACT_PHONE}`} className="text-gray-900 hover:underline">{phoneDisplay}</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{DEFAULT_SITE_NAME}<br />{DEFAULT_CONTACT_ADDRESS}</p>
                  </div>
                </div>
              </div>
            </div>
