  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto p-4 space-y-6">
        <div className="bg-[#BE185D]/5 border border-[#BE185D]/20 rounded-xl p-4">
          <div className="flex gap-3">
            <i className="ri-shield-check-line text-xl text-[#BE185D] flex-shrink-0 mt-0.5"></i>
            <div>
              <h3 className="font-semibold text-[#BE185D] mb-1">Your Privacy Matters</h3>
