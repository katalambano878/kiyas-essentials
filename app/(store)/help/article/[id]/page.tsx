                ...
                {wasHelpful ? (
                  ...
                  <>
                    <div className="w-16 h-16 flex items-center justify-center bg-[#BE185D]/10 rounded-full mx-auto mb-4">
                      <i className="ri-customer-service-line text-3xl text-[#BE185D]"></i>
                    </div>
                    <p className="text-lg font-semibold text-gray-900 mb-2">
                    ...
                    <Link
                      href="/support/ticket"
                      className="inline-block bg-[#BE185D] hover:bg-[#9D174D] text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
                    >
                      Contact Support
                    </Link>
                  </>
