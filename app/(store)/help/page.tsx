      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              <div className="w-16 h-16 flex items-center justify-center bg-[#BE185D]/10 rounded-full mx-auto mb-4">
                <i className="ri-customer-service-2-line text-3xl text-[#BE185D]"></i>
              </div>
              ...
              <span className="text-[#BE185D] font-semibold whitespace-nowrap">Create Ticket →</span>
            </Link>
            ...
            >
              <div className="w-16 h-16 flex items-center justify-center bg-[#BE185D]/10 rounded-full mx-auto mb-4">
                <i className="ri-arrow-left-right-line text-3xl text-[#BE185D]"></i>
              </div>
              ...
              <span className="text-[#BE185D] font-semibold whitespace-nowrap">Initiate Return →</span>
            </Link>
            ...
            >
              <div className="w-16 h-16 flex items-center justify-center bg-[#FFFFCC] rounded-full mx-auto mb-4">
                <i className="ri-map-pin-line text-3xl text-[#BE185D]"></i>
              </div>
              ...
              <span className="text-[#BE185D] font-semibold whitespace-nowrap">Track Now →</span>
            </Link>
          </div>
        </div>
      </main>
