...
import { resolveCategoryImage } from '@/lib/category-covers';
...
export default async function CategoriesPage() {
  ...
  const palette = [
    { color: 'from-[#F472B6] to-[#BE185D]', icon: 'ri-store-2-line' },
    { color: 'from-[#BE185D] to-[#9D174D]', icon: 'ri-shopping-bag-3-line' },
    { color: 'from-[#FDA4AF] to-[#BE185D]', icon: 'ri-t-shirt-line' },
    { color: 'from-[#FFCC00] to-[#BE185D]', icon: 'ri-home-smile-line' },
    { color: 'from-[#9D174D] to-[#F472B6]', icon: 'ri-heart-line' },
  ...
  return (
    <div className="min-h-screen bg-white">
      <PageHero
        ...
        subtitle="Girly accessories, daily essentials, content creation tools, home decor, tripods & more — browse by collection."
        image="/products/perfume-set.png"
      />
            ...
            {categories.map((category) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center text-[#BE185D] font-medium text-sm group-hover:gap-2 transition-all">
      ...
      <div className="bg-gradient-to-br from-[#BE185D] to-[#9D174D] py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="/shop"
              className="inline-flex items-center gap-2 bg-white text-[#BE185D] px-8 py-4 rounded-full font-medium hover:bg-rose-50 transition-colors whitespace-nowrap"
            >
